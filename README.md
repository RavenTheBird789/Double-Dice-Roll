# Double-Dice-Roll
Python program for a simple game of chance where the goal is to roll two dice and the sum of their values add up to a value greater than another value decided at random
